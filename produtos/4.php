        ...
        <div id="tudo" class="">
            ...
            <main style="padding: 5px 0;">
                ...
                <div id="section1" class="container">
                        <div class="fleft w30">
                            <h2>Blusa Manga Trigueiro<br> Estampado </h2> 
                            <p>Cod: 0095-205-02</p>
                            <p style="margin: 20px 0;">Esse modelo esta com tudo ainda em 2018, muito linda, romantica, moderna e muito feminina, fazendo com que toda mulher moderna, tenha pelo menos uma no guarda roupas. <a href="">Ver mais.</a></p>
                        ...
                        <div id="animg" class="fleft w30" >
                            <a style="cursor:zoom-in;" href="https://mariafilo.vteximg.com.br/arquivos/ids/212209-500-650/04013048_019_2-BLUSA-MANGA-TRIGUEIRO.jpg?v=636718539106730000" target="_blank"><img class="" src="https://mariafilo.vteximg.com.br/arquivos/ids/212209-500-650/04013048_019_2-BLUSA-MANGA-TRIGUEIRO.jpg?v=636718539106730000" width="auto" height="500"/></a>
                        </div>
                        <div class="fleft w30">
                            <h3>R$ 299,00</h3> 
                            <p>até 2x de R$ 149,50</p>
                            <p>Vendido e Enviado por StarClothes</p>
                            <br>
                            <p><b>Cor:</b>  Estampado</p>
                            <br>
                            <p>
                                <form>
                ...
                <div class="container">
                    ...
                    <br>
                    <h2>Descrição</h2>
                    <p>Esse modelo esta com tudo ainda em 2018, muito linda, romantica, moderna e muito feminina, fazendo com que toda mulher moderna, tenha pelo menos uma no guarda roupas.</p>
                    <br>
                    <div class="fleft" style="margin: 0 12%;">
                        <b>Nome:</b> Blusa Manga Trigueiro - Estampado<br>
                        <b>Gênero:</b> Feminino<br>
                        <b>Indicado para:</b> Dia a Dia<br>
                        <b>Ocasião:</b> Trabalho ou Lazer
                    </div>
                    <div style="margin: 0 12%;" class="fleft ">
                        <b>Estilo da Peça:</b> Estampada - Manga Trigueiro<br>
                        <b>Modelagem:</b> Trigueiro<br>
                        <b>Material:</b> 94% viscose e 6% elastano<br>
                        <b>Tipo:</b> Manga Trigueiro
                    </div>
                                ...
                                <div id="myCarousel" class="carousel slide">
                                    ...
                                    <div class="item active">
                                            <div class="row-fluid">
                                              ...
                                              <div class="span3"><a href="../produtos/5.php" class="thumbnail"><img src="https://mariafilo.vteximg.com.br/arquivos/ids/209897-500-650/01030898_038_2-VESTIDO-RENDA-FIVELA-CROCHE.jpg?v=636683067046200000" alt="Image" style="max-width:100%;" /></a></div>
                                            </div><!--/row-fluid-->
                                    </div><!--/item-->
