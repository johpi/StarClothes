        ...
        <div id="tudo" class="">
            ...
            <main style="padding: 5px 0;">
                ...
                <div id="section1" class="container">
                        <div class="fleft w30">
                            <h2>Vestido Midi Jatobá<br> Estampado </h2> 
                            <p>Cod: 0095-205-02</p>
                            <p style="margin: 20px 0;">Nada como um vestido estampado para compor um look fresh em dias quentes.
                                Use com uma sapatilha e uma bolsa tira colo para compor um visual moderno e charmoso.<a href="">Ver mais.</a></p>
                        ...
                        <div id="animg" class="fleft w30" >
                            <a style="cursor:zoom-in;" href="https://mariafilo.vteximg.com.br/arquivos/ids/211879-500-650/04061822_019_2-VESTIDO-MIDI-JATOBA.jpg?v=636715629161170000" target="_blank"><img class="" src="https://mariafilo.vteximg.com.br/arquivos/ids/211879-500-650/04061822_019_2-VESTIDO-MIDI-JATOBA.jpg?v=636715629161170000" width="auto" height="500"/></a>
                        </div>
                        <div class="fleft w30">
                            <h3>R$ 499,00</h3> 
                            <p>até 4x de R$ 124,75</p>
                ...
                <div class="container">
                    ...
                    <br>
                    <h2>Descrição</h2>
                    <p> Nada como um vestido estampado para compor um look fresh em dias quentes.
                        Use com uma sapatilha e uma bolsa tira colo para compor um visual moderno e charmoso.
                    </p>
                    <br>
                    <div class="fleft" style="margin: 0 12%;">
                        <b>Nome:</b> Vestido Midi Jatobá - Estampado<br>
                    ...
                    <div style="margin: 0 12%;" class="fleft ">
                        ...
                        <b>Modelagem:</b> midi<br>
                        <b>Material:</b> 87% poliéster e 13% elastano<br>
                        <b>Tipo:</b> Vestido Longo
                    </div>
