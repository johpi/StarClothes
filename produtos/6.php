        ...
        <div id="tudo" class="">
            ...
            <main style="padding: 5px 0;">
                ...
                <div id="section1" class="container">
                        <div class="fleft w30">
                            <h2>Blusa Bordado Floral Neblina<br> Decote Bordado</h2> 
                            <p>Cod: 0095-205-02</p>
                            <p style="margin: 20px 0;">Confeccionada em tecido leve. O destaque do modelo é o decote em V com bordados.
                                O caimento é solto e as mangas são longas. Cai muito bem com looks despojados e elegantes.<a href="">Ver mais.</a></p>
                ...
                <div class="container">
                    ...
                    <br>
                    <h2>Descrição</h2>
                    <p>Confeccionada em tecido leve. O destaque do modelo é o decote em V com bordados.
                                O caimento é solto e as mangas são longas. Cai muito bem com looks despojados e elegantes.</p>
                    <br>
                    <div class="fleft" style="margin: 0 12%;">
                        <b>Nome:</b> Blusa Bordado Floral Neblina<br>
                        <b>Gênero:</b> Feminino<br>
                        <b>Indicado para:</b> Dia a Dia<br>
                        <b>Ocasião:</b> Trabalho e Lazer
                    </div>
                    <div style="margin: 0 12%;" class="fleft ">
                        <b>Estilo da Peça:</b> Decote Bordado<br>
                        <b>Modelagem:</b> Decote Bordado<br>
                        <b>Material:</b> 100% Viscose<br>
                        <b>Tipo:</b> Blsuinha Decote Bordado
                    </div>
